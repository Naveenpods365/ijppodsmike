    ...
    >
      ...
      <div className="relative flex items-start justify-between">
        <div className="space-y-3">
          ...
          <p className="text-3xl font-bold text-card-foreground animate-count">{value}</p>
          {change && (
            <div className={cn(
              ...
              {changeType === "positive" && <span className="text-success">↑</span>}
              {changeType === "negative" && <span className="text-destructive">↓</span>}
              {change}
            </div>
          )}
        </div>
