...
import {
    getRecentRuns,
    getScheduledJobs,
    setIsOpenAddSchedulerPopup,
    setIsOpenScrapperSelectPopup,
    toggleSchedule,
...
const getDerivedDurationSeconds = (startedAt, finishedAt) => {
...
const Scheduler = () => {
    ...
    const isLoading =
        scrapeCostcoLoading || scrapeBestBuyLoading || scrapeWalmartLoading;
    ...
    const handleToggleSchedule = async (id, isActive) => {
        try {
            await dispatch(
                toggleSchedule({ id, is_active: isActive })
            ).unwrap();
        } catch (error) {
            toast({
                title: "Error",
    ...
    return (
        <div className="flex min-h-screen bg-background">
            ...
            <div className="flex-1 flex flex-col min-h-screen relative">
                <Header
                    title="Scheduler"
                    subtitle="Automate your deal broadcasts"
                />
                ...
                <main className="flex-1 p-8 space-y-8 overflow-y-auto">
                    ...
                    <div className="flex items-center justify-between animate-fade-in">
                        ...
                        <Button
                            ...
                            onClick={() =>
                                dispatch(setIsOpenScrapperSelectPopup(true))
                            }
                        >
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-3xl font-bold text-foreground mt-1">
                                                {formatNextRunInSeconds(
                                                    metrics.next_run_in_seconds
                                                )}
                                            </p>
                                        </div>
                        ...
                        <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
                            <CardHeader className="flex flex-row items-center justify-between">
                                ...
                                <Button
                                    ...
                                    onClick={() =>
                                        dispatch(
                                            setIsOpenAddSchedulerPopup(true)
                                        )
                                    }
                                >
            ...
            <DealsPopup
                open={showDealsPopup}
                onOpenChange={setShowDealsPopup}
                runId={selectedRunId}
            />
